...
START TRANSACTION;
USE `mcas`;
INSERT INTO `mcas`.`source` (`id`, `url`, `key`) VALUES (DEFAULT, 'https://tsn.ua', 231);
INSERT INTO `mcas`.`source` (`id`, `url`, `key`) VALUES (DEFAULT, 'https://radio.nv.ua', 34);
...
START TRANSACTION;
USE `mcas`;
INSERT INTO `mcas`.`role` (`name`, `description`) VALUES ('user', 'User');
INSERT INTO `mcas`.`role` (`name`, `description`) VALUES ('admin', 'Administrator');
...
START TRANSACTION;
USE `mcas`;
INSERT INTO `mcas`.`user` (`login`, `name`, `password`) VALUES ('artem12333', 'Artem', 'qwertyui');
INSERT INTO `mcas`.`user` (`login`, `name`, `password`) VALUES ('user1_login', 'user1_name', 'secret_password');
